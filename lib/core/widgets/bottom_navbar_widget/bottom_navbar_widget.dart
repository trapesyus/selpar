...
import 'package:selpar/screen/bottom_navbar_end_drawer_subscreen/hesap_screen/hesap_screen.dart';
        ...
        child: Row(
          ...
          children: <Widget>[
            Expanded(
              ...
              ).getPaddingOnly(context: context, left: 0.04, right: 0.14),
            ),
            Expanded(
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
              ...
              ).getPaddingOnly(context: context, right: 0.04, left: 0.14),
            ),
          ],
        ));
  }
      ...
      child: ListView(
        ...
        children: <Widget>[
          ...
          ListTile(
            ...
            onTap: () async =>
                await const HesapScreen().navigateEffectiveTo(context: context),
          ),
          ListTile(
            title: Row(
              children: [
            ...
            onTap: () async => await LanguageScreen(isPreloadingScreen: false)
        ...
        children: <Widget>[
          ...
          ExpansionTile(
            ...
            children: [
              ...
              _drawerListTile(
                ...
                onTap: () async => await TahsilatiYapilmayanOnarimlar()
                    .navigateEffectiveTo(context: context),
              ),
              _drawerListTile(
                context: context,
          ...
          ExpansionTile(
            ...
            children: [
              ...
              _drawerListTile(
                  context: context,
                  subTitle: LanguageService
                      .choosenLanguage['key']!.bugunYapilacakTahsilatlar!,
                  onTap: () {}),
              _drawerListTile(
                  context: context,
                  subTitle: LanguageService.choosenLanguage['key']!.odemeEkle!,
                  onTap: () async =>
              ...
              _drawerListTile(
                  context: context,
                  subTitle: LanguageService
                      .choosenLanguage['key']!.bugunYapilacakOdemeler!,
                  onTap: () {}),
              _drawerListTile(
                  context: context,
                  subTitle: LanguageService
                      .choosenLanguage['key']!.butunAlacaklarOdemeler!,
                  onTap: () {})
            ],
          ),
          ExpansionTile(
          ...
          ExpansionTile(
            title: Row(
              children: [
                ...
                Expanded(
                  child: CustomLabelText(
                      label: LanguageService
                          .choosenLanguage['key']!.alimSatimIslemleri!,
                      isColorNotWhite: true),
                ),
              ],
            ),
            children: [
              ...
              _drawerListTile(
                  context: context,
                  subTitle: LanguageService.choosenLanguage['key']!.alisIslemi!,
                  onTap: () async =>
          ...
          ExpansionTile(
            title: Row(
              children: [
                ...
                Expanded(
                  child: CustomLabelText(
                      label: LanguageService.choosenLanguage['key']!.eIslemler!,
                      isColorNotWhite: true),
                ),
              ],
            ),
