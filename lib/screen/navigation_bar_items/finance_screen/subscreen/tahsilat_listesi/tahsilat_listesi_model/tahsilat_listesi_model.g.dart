...
part of 'tahsilat_listesi_model.dart';
...
mixin _$TahsilatListesiModel on _TahsilatListesiModelBase, Store {
  late final _$sharedCalendarStartAtom = Atom(
      name: '_TahsilatListesiModelBase.sharedCalendarStart', context: context);
  ...
  late final _$sharedCalendarFinishAtom = Atom(
      name: '_TahsilatListesiModelBase.sharedCalendarFinish', context: context);
