...
part of 'silinen_kabul_listesi_model.dart';
...
mixin _$SilinenKabulListesiModel on _SilinenKabulListesiModelBase, Store {
  late final _$sharedCalendarStartAtom = Atom(
      name: '_SilinenKabulListesiModelBase.sharedCalendarStart',
      context: context);
  ...
  late final _$sharedCalendarFinishAtom = Atom(
      name: '_SilinenKabulListesiModelBase.sharedCalendarFinish',
      context: context);
